            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="bg-muted/50 rounded-lg p-4 space-y-2 text-sm">
                  <p><strong>Identidad:</strong> ASOCIACIÓN AHORA</p>
                  <p><strong>NIF:</strong> G56789012</p>
                  <p><strong>Dirección:</strong> C/ Aragón 578, 08026 Barcelona</p>
                  <p><strong>Email:</strong> info@ahoraorg.es</p>
                  <p><strong>Registro:</strong> Registro Nacional de Asociaciones Nº 631679</p>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground mt-4">
                  <li><strong>Consentimiento:</strong> al completar el formulario de inscripción y aceptar esta política</li>
                  <li><strong>Ejecución de contrato:</strong> para la gestión de tu condición de socio</li>
                  <li><strong>Obligación legal:</strong> para el cumplimiento de obligaciones legales aplicables</li>
                  <li><strong>Interés legítimo:</strong> para el envío de comunicaciones sobre actividades de la asociación</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  durante los plazos legalmente establecidos. Los datos de navegación se conservan durante un máximo de 2 años.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  Podrán tener acceso a los datos los encargados del tratamiento que presten servicios a la asociación 
                  (entidades bancarias para la gestión de cobros, proveedores de servicios informáticos, etc.).
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-4">
                  Para ejercer estos derechos, puedes contactar con nosotros en <a href="mailto:info@ahoraorg.es" className="text-primary hover:underline">info@ahoraorg.es</a>.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  La Asociación AHORA ha adoptado las medidas técnicas y organizativas necesarias para garantizar 
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  ante la Agencia Española de Protección de Datos (<a href="https://www.aepd.es" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">www.aepd.es</a>).
                </p>
              </div>

              <div className="bg-primary/10 rounded-xl p-6 mt-8">
                <p className="text-sm text-muted-foreground">
                  La Asociación AHORA se reserva el derecho a modificar esta política de privacidad para adaptarla 
                  a novedades legislativas o jurisprudenciales. En caso de introducir modificaciones sustanciales, 
                  se comunicará a los socios a través del email proporcionado.
                </p>
              </div>
            </div>
          </div>
