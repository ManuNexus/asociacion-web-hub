...
const NoticiaDetalle = () => {
  ...
  // Use edge function URL for social sharing to get dynamic OG tags
  const ogShareUrl = noticia ? `https://ihxczttkofjnyviqmxpl.supabase.co/functions/v1/og-news?id=${noticia.id}` : "";
  ...
  const socialLinks = [
    {
      ...
      url: `https://twitter.com/intent/tweet?text=${encodeURIComponent(shareTitle)}&url=${encodeURIComponent(ogShareUrl)}`,
    },
    {
      name: "Facebook",
      icon: (
    ...
    },
    {
      ...
      url: `https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(ogShareUrl)}&title=${encodeURIComponent(shareTitle)}`,
    },
    {
      name: "WhatsApp",
      icon: (
      ...
      url: `https://wa.me/?text=${encodeURIComponent(shareTitle + " " + ogShareUrl)}`,
    },
    {
      name: "Telegram",
      icon: (
      ...
      url: `https://t.me/share/url?url=${encodeURIComponent(ogShareUrl)}&text=${encodeURIComponent(shareTitle)}`,
    },
  ];
